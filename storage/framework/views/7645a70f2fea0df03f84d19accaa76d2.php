                                            ...
                                            <tr id="<?php echo e($item->id); ?>">
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-info"
                                                        onclick="editStaff(<?php echo e($item->id); ?>)">
                                                        <i class="fa-solid fa-pencil"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-danger"
                                                        onclick="deleteStaff(<?php echo e($item->id); ?>)">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\Project\Transport\transport\resources\views/owner/data-staff.blade.php ENDPATH**/ ?>