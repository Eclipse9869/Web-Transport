                    ...
                    <div x-data="{
                        ...
                        <a href="/detail-product/<?php echo e($item->id); ?>">
                            ...
                            <?php if($item->packageImages->isEmpty()): ?>
                                <img src="<?php echo e(asset('img/default.jpg')); ?>" 
                                    alt="default image" 
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\Project\Transport\transport\resources\views/customer/shop.blade.php ENDPATH**/ ?>