<?php $__env->startSection('content'); ?>
    ...
    <div class="container py-4">
        <form id="checkout-form" method="POST" action="<?php echo e(route('checkout.index')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                    ...
                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="space-y-2 mt-5">
                            <div class="flex justify-between">
                                <h5 class="text-gray-800 font-medium"><?php echo e($c['name']); ?></h5>
                                <div class="">
                                    <p class="text-gray-500 text-sm">Rp <?= number_format($c['price'], 0, ',' , '.') ?></p>
                                    <p class="text-gray-500 text-sm"><?php echo e($c['qty']); ?> pax</p>
                                </div>
                            </div>
                            <div class="flex justify-between text-gray-800 font-medium py-3 uppercase">
                                <p>Subtotal</p>
                                <p>Rp <?= number_format($c['price'] * $c['qty'], 0, ',' , '.') ?></p>
                            </div>
                            <div class="flex justify-between text-gray-800 font-medium py-3 uppercase">  
                                <p>Date</p>
      ...
      payButton.addEventListener('click', function () {
        ...
        window.snap.pay('<?php echo e($snapToken); ?>', {
          onSuccess: function(result){
            ...
            window.location.href = '/invoice/<?php echo e($transaction->id); ?>'
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\Project\Transport\transport\resources\views/customer/checkout.blade.php ENDPATH**/ ?>