                                ...
                                <table id="datatable-1" class="table data-table table-striped table-bordered">
                                    ...
                                    <tbody id="car-table">
                                        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="car-<?php echo e($item->id); ?>">
                                                <td><?php echo e($item->id); ?></td>
                                                <td><?php echo e($item->name); ?></td>
                                                <td><?php echo e($item->descriptions); ?></td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary" onclick="viewImages(<?php echo e($item->id); ?>)">
                                                        View Images
                                                    </button>
                                                    <!-- Simpan gambar dalam elemen tersembunyi -->
                                                    <div id="car-images-<?php echo e($item->id); ?>" class="d-none">
                                                        <?php $__currentLoopData = $item->carImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <img src="<?php echo e(asset('img/car/' . $image->image)); ?>" alt="Car Image"
                                                                width="100" height="75" class="m-1">
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button class="btn btn-sm btn-info" onclick="editCar(<?php echo e($item->id); ?>)">
                                                        <i class="fa-solid fa-pencil"></i>
                                                    </button>
                                                    <!-- <button class="btn btn-sm btn-danger" onclick="deleteCar(<?php echo e($item->id); ?>)">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH B:\Project\Transport\transport\resources\views/staff/car/data-car.blade.php ENDPATH**/ ?>